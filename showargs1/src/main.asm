...
; MAIN PROGRAM
_start:
    mov     rbp, rsp              ; save the initial stack pointer in RBP

    ; validate the command line argument count
    cmp     qword [rbp], MAXARGS  ; see if the arg count exceeds MAXARGS
...
ScanOne:
    ...
    mov     rdi, qword [rbp + 8 + rbx * 8]  ; put address of string to search in RDI
    ...
    cmp     rbx, [rbp]                      ; see if arg counter exceeds argument counter
